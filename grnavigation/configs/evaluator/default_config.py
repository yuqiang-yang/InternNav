...
from grnavigation.configs.model import cma_cfg, rdp_cfg, seq2seq_cfg, internvla_n1_cfg

from grnavigation.projects.internutopia_vln_extension.configs.controllers.stand_still import (
    StandStillControllerCfg,
)
from grnavigation.projects.internutopia_vln_extension.configs.robots.h1 import (
    vln_move_by_speed_cfg as h1_vln_move_by_speed_cfg,
)
from grnavigation.projects.internutopia_vln_extension.configs.sensors.vln_camera import VLNCameraCfg
...
from grnavigation.configs.model import cma_cfg, rdp_cfg, seq2seq_cfg
from grnavigation.projects.internutopia_vln_extension.configs.controllers.discrete_controller import (
    DiscreteControllerCfg,
)
from grnavigation.projects.internutopia_vln_extension.configs.controllers.stand_still import (
    StandStillControllerCfg,
)
from grnavigation.projects.internutopia_vln_extension.configs.metrics.vln_pe_metrics import (
    VLNPEMetricCfg,
)
from grnavigation.projects.internutopia_vln_extension.configs.robots.h1 import (
...
def get_config(evaluator_cfg: EvalCfg):
    ...
    if evaluator_cfg.task.robot_name == 'h1':
        ...
        robot_usd_path_ = getattr(evaluator_cfg.task, 'robot_usd_path',  '/robots/h1/h1_vln_pano_pointcloud_200.usd')
        robot_usd_path = gm.ASSET_PATH + robot_usd_path_
        camera_resolution = getattr(evaluator_cfg.task, 'camera_resolution',  [256,256])
