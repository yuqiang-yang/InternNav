...
def eval_dual():
    ...
    dual_sys_output = agent.step(image, depth, camera_pose, instruction, intrinsic=args.camera_intrinsic, look_down=look_down)
...
if __name__ == '__main__':
    ...
    args.camera_intrinsic = np.array([[386.5        ,   0.        , 328.9,   0.        ],
            [  0.        , 386.5        , 244,   0.        ],
            [  0.        ,   0.        ,   1.        ,   0.        ],
            [  0.        ,   0.        ,   0.        ,   1.        ]])
